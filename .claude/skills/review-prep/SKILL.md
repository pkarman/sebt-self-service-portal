...
- **Configuration changes**: Flag separately. Additions and changes to configuration keys should **always** be prominently flagged and prioritized **high**.
...
🔴 **High**: New libraries, significant departures from existing code. New/changed configuration keys that may require IaC/Tofu changes.
